...
class KitsuneSockFactory {
    createServer(express, eventHandler) {
        return __awaiter(this, void 0, void 0, function* () {
            const promise = new Promise((resolve, reject) => {
                ...
                server.on(kitsune_wrapper_library_1.SOCK.CONNECTION, (socket) => __awaiter(this, void 0, void 0, function* () {
                    if (socket.handshake.auth && socket.handshake.auth.token) {
                        ...
                        const sockets = yield server.fetchSockets();
                ...
                server.on(kitsune_wrapper_library_1.SOCK.GZIPPED_EVENT, (socket) => __awaiter(this, void 0, void 0, function* () {
                    console.log('ready to send the asset data r0', socket);
                }));
                server.on(kitsune_wrapper_library_1.SOCK.AP_REQ, (socket) => __awaiter(this, void 0, void 0, function* () {
                    console.log('ready to send the asset data r1', socket);
                }));
                server.on(kitsune_wrapper_library_1.SOCK.PY_REQ, (socket) => __awaiter(this, void 0, void 0, function* () {
